            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="row mb-3">
                <div className="col-md-12 mb-3">
                  ...
                  />
                  {errors.industryName && <small className="text-danger">{errors.industryName}</small>}
                </div>
                ...
                <div className="col-md-6 mb-3">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  {errors.establishmentYear && <small className="text-danger">{errors.establishmentYear}</small>}
                </div>
                <div className="col-md-6 mb-3">
                  <input
                    type="text"
